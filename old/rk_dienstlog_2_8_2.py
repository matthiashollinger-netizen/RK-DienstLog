...
- Changelog-Fenster als zentrale Übersicht für vergangene und zukünftige Änderungen vorbereitet.

Version 2.8.0
- Auto-Update für macOS ergänzt.
- Menüpunkt „Hilfe → Nach Updates suchen“ ergänzt.
- Automatische Update-Prüfung beim Start ergänzt.
- Versionierung über version.json vorbereitet.

Version 2.7.7
- Windows-Fenster- und Taskleistenicon verbessert.
- Windows-Icon zusätzlich als Datenfile eingebunden.
- Plattformübergreifende Icon-Logik ergänzt.

Version 2.7.6
- macOS-Icon-Verhalten stabilisiert.
- Übermäßiges Icon-Nachsetzen entfernt.
- Ruhigeres Verhalten im Dock und App-Umschalter.

Version 2.7.x
- App-Name auf „RK DienstLog“ geändert.
- Splash-Screen mit App-Icon ergänzt.
- macOS .app Build vorbereitet.
- App-Icon für macOS und Windows erstellt.

Version 2.6.x
- Monatsformat global auf MM/JJJJ umgestellt.
- Einheiten/Züge bereinigt, z.B. „Zug 11“ statt „Zug 11 (Abteilung Salzburg 2)“.
- „Einträge“ in vielen Ansichten auf „Dienste“ umgestellt.
- Singular/Plural bei „Dienst/Dienste“ verbessert.
- Escape-Taste für Dialogfenster ergänzt.

Version 2.5.x
- Export verbessert.
- Kalenderexport mit Monatsauswahl ergänzt.
- Export-Fenster scrollbar gemacht.
- Kalenderansicht nur bei ausgewähltem Monat angezeigt.

Version 2.4.x
- Kalenderansicht ergänzt.
- Detail-Drilldown per Doppelklick auf Monat oder Einheit ergänzt.
- Auto-Speicher für letzte Daten und Filter ergänzt.
- Statuszeile und kleinere UI-Verbesserungen ergänzt.

Version 2.3.x
- Hover-Tooltips für Monatsgrafik und Verlauf ergänzt.
- Werte in Grafiken gerundet angezeigt.

Version 2.2.x
- Monatsgrafik ergänzt.
- Kumulative Verlaufsgrafik ergänzt.
- Erweiterte Filter nach Art, Monat und Einheit ergänzt.
- Export als Excel und PNG ergänzt.
- Dark/Light Mode ergänzt.

Version 2.1.x
- Copy/Paste-Fenster mit Excel-ähnlicher Vorschau ergänzt.
- Tabellen per Spaltenkopf sortierbar gemacht.

Version 2.0.x
- Neuaufbau mit modernem CustomTkinter-Design.
- CSV/Excel-Import beibehalten.
- Copy/Paste aus dem Webportal ergänzt.
- Übersicht, Monatsübersicht, Zug-/Einheitübersicht und Datensätze ergänzt.

Version 1.x
- Erste Version als einfacher Stundenrechner.
- CSV/Excel-Import.
- Filter auf RKT-FRW.
- Grundauswertung nach Monat und Einheit.
"""
...
chmod +x "$OLD_APP/Contents/MacOS/RK DienstLog"
